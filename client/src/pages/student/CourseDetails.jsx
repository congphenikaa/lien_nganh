...
const CourseDetails = () => {
  ...
  return courseData ? (
      ...
      justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">  
        ...
        <div className="absolute top-0 left-0 w-full h-[var(--section-h)] -z-1
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>Huu Cong</span></p>
                  ...
                  border-t border-gray-300'>
                    {chapter.chapterContent.map((lecture, i)=> (
                      <li key={i} className='flex items-start gap-2 py-1'>
                        <img src={assets.play_icon} alt="phay icon"  className='w-4
                        h-4 mt-1'/>
                        <div className='flex items-center justify-between w-full
                        text-gray-800 text-xs md:text-default'>
                          <p>{lecture.lectureTitle}</p>
                          <div className='flex gap-2'>
                            {lecture.isPreviewFree && <p className='text-blue-500
